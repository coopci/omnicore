...
"> curl --user myusername --data - binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", \"method\": \"omni_createrawtx_opreturn\", \"params\": [\"01000000000000000000\", \"00000000000000020000000006dac2c0\"] }' - H 'content-type: text/plain;' http://127.0.0.1:8332/"
		);
...
static UniValue omni_createrawtx_multisig(const JSONRPCRequest& request)
{
	...
	"\"rawtx\"                 (string)the hex - encoded modified raw transaction"
		...
		"Examples :"
"> omnicore - cli omni_createrawtx_multisig \"0100000001a7a9402ecd77f3c9f745793c9ec805bfa2e14b89877581c734c774864247e6f50400000000ffffffff01aa0a0000000000001976a9146d18edfe073d53f84dd491dae1379f8fb0dfe5d488ac00000000" "00000000000000020000000000989680\" \"1LifmeXYHeUe2qdKWBGVwfbUCMMrwYtoMm" "0252ce4bdd3ce38b4ebbc5a6e1343608230da508ff12d23d85b58c964204c4cef3\""
"> curl --user myusername --data - binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", \"method\": \"omni_createrawtx_multisig\", \"params\": [\"0100000001a7a9402ecd77f3c9f745793c9ec805bfa2e14b89877581c734c774864247e6f50400000000ffffffff01aa0a0000000000001976a9146d18edfe073d53f84dd491dae1379f8fb0dfe5d488ac00000000\", \"00000000000000020000000000989680\", \"1LifmeXYHeUe2qdKWBGVwfbUCMMrwYtoMm\", \"0252ce4bdd3ce38b4ebbc5a6e1343608230da508ff12d23d85b58c964204c4cef3\"] }' - H 'content-type: text/plain;' http://127.0.0.1:8332/"
		);
...
static UniValue omni_createrawtx_input(const JSONRPCRequest& request)
{
	...
	"1. rawtx(string, required) the raw transaction to extend(can be null)"
		...
		"3. n(numeric, required) the index of the transaction output used as input"
...
"> curl --user myusername --data - binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", \"method\": \"omni_createrawtx_input\", \"params\": [\"01000000000000000000\", \"b006729017df05eda586df9ad3f8ccfee5be340aadf88155b784d1fc0e8342ee\", 0] }' - H 'content-type: text/plain;' http://127.0.0.1:8332/"
...
static UniValue omni_createrawtx_reference(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
        throw std::runtime_error(
			...
			"omni_createrawtx_reference \"rawtx\" \"destination\" (\"referenceamount\")"
	...
	"1. rawtx(string, required) the raw transaction to extend(can be null)"
		...
		"3. referenceamount(string) the optional reference amount(minimal by default)"
...
"> curl --user myusername --data - binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", \"method\": \"omni_createrawtx_reference\", \"params\": [\"\", \"1CE8bBr1dYZRMnpmyYsFEoexa1YoPz2mfB\", 0.005] }' - H 'content-type: text/plain;' http://127.0.0.1:8332/"
...
static UniValue omni_createrawtx_change(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 4 || request.params.size() > 5)
        throw std::runtime_error(
			...
			"omni_createrawtx_change \"rawtx\" [{\"txid:hash\":\"str\",\"vout:n\":n,\"scriptPubKey:hex\":\"str\",\"value:n.nnnnnnnn\":n},...] \"destination\" fee ( position )"
	...
	"1. rawtx(string, required) the raw transaction to decode"
		...
		"2. prevtxs(json array, required) a JSON array of transaction inputs"

	"{                               (json object)"
	"\"txid:hash\": \"str\",           (string, required) the transaction hash"

		"\"vout:n\": n,                  (numeric, required) the output number"

		"\"scriptPubKey:hex\": \"str\",    (string, required) the output script"

		"\"value:n.nnnnnnnn\": n,        (numeric, required) the output value"
	...
	"3. destination(string, required) the destination for the change"
		...
		"4. fee(numeric, required) the desired transaction fees"

		"5. position(numeric, optional, default = first position) the position of the change output"
...
"> curl --user myusername --data - binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", \"method\": \"omni_createrawtx_change\", \"params\": [\"\", [{\"txid\":\"6779a710fcd5f6fb0883ea3306360c3ad8c0a3c5de902768ec57ef3104e65eb1\",\"vout\":4,\"scriptPubKey\":\"76a9147b25205fd98d462880a3e5b0541235831ae959e588ac\",\"value\":0.00068257}], \"1CE8bBr1dYZRMnpmyYsFEoexa1YoPz2mfB\", 0.00003500, 1] }' - H 'content-type: text/plain;' http://127.0.0.1:8332/"
		);
